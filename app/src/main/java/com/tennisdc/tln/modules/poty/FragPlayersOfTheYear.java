package com.tennisdc.tln.modules.poty;
...
import com.tennisdc.tln.model.potyresponse.PLAYERSOFTHEYEARItem;
...
public class FragPlayersOfTheYear extends Fragment {
    ...
    class PLAYERSOFTHEYEARViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private PLAYERSOFTHEYEARViewHolder(View itemView) {
            super(itemView);
...
//                profileImage.setImageURI(item.getProfileImage());
...
//            championCup.setDefaultImageResId(android.R.drawable.ic_menu_gallery);
            championCup.setImageResource(android.R.drawable.ic_menu_gallery);
...
//                championCup.setImageURI(item.getChampionCupImage());
