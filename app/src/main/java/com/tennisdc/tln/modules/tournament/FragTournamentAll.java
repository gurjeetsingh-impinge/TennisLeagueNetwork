...
import com.tennisdc.tln.modules.tournament.updated.TournamentFragment;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQ_COMPETITION) {
            if (resultCode == Activity.RESULT_OK && data != null) {
                ...
                getActivity().getSupportFragmentManager().beginTransaction().add(R.id.fragmentContainer, TournamentFragment.newInstance(mCurCompetition)).commit();
...
//        fetchCompetitionList();
    ...
    public void onResume() {
        super.onResume();
        getActivity().setTitle("My Tourney's");
    }
        ...
        WSHandle.Tournament.getCompetitionList(player.id, new VolleyHelper.IRequestListener<List<Competition>, String>() {
            ...
            public void onSuccessResponse(List<Competition> response) {
                ...
                if (response == null || response.size() <= 0) {
                    ...
                    startActivityForResult(FragListSelection.getInstance(getActivity(), Parcels.wrap(response), "My Tourney's", getString(R.string.alert_msg_select_a_competition)), REQ_COMPETITION);
                }
            }
    ...
    private void fetchTournamentReport(final Competition competition/*, List<
            TournamentRound> tournamentRoundList*/) {
        ...
        WSHandle.Tournament.getTournamentReport(competition.CompetitionId, new VolleyHelper.IRequestListener<JSONObject, String>() {
            ...
            public void onSuccessResponse(JSONObject response) {
                try {
                    ...
                    final List<PlayerDetail> playerDetails = gson.fromJson(response.getString("tournament_details"), new TypeToken<List<PlayerDetail>>() {
                    }.getType());
