...
public class YearPickerDialog implements Dialog.OnClickListener {
    ...
    private void build() {
        ...
        textOk = (TextView) contentView.findViewById(R.id.ok);
        final TextView textCancel = (TextView) contentView.findViewById(R.id.cancel);

        //If there is user's title color,
        if (mTextTitleColor != -1) {
            //Then apply it.
            setTextColor(textCancel);
        }
...
//        yearPicker.setDisplayedValues(years);
        ...
        setCurrentDate(yearPicker, textCancel);

        //Setting all listeners.
        setListeners(yearPicker, textCancel, textOk);
...
//        mDialogBuilder.setNegativeButton("CANCEL", this);
    ...
    private void setCurrentDate(NumberPickerWithColor yearPicker, TextView buttonCancel) {
...
//        buttonOk.setText(monthFormat.format(calendar.getTime()));
//        buttonCancel.setText(Integer.toString(mYear));
        ...
        yearPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
            ...
            public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
                /*if (newVal > Calendar.getInstance().get(Calendar.YEAR)) {
                    textOk.setTextColor(ContextCompat.getColor(mContext, R.color.gray_1));
                    tempYear = newVal;
                } else {*/
                    mYear = newVal;
                    tempYear = mYear;
                    textOk.setTextColor(ContextCompat.getColor(mContext, R.color.white));
                /*}*/
