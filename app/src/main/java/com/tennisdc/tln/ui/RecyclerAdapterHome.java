 ...
 */
public abstract class RecyclerAdapterHome<T, T2 extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T2> {
...
*/
    ...
    public RecyclerAdapterHome(T[] dataSet) {
        mDataSet = dataSet;
    }

    public RecyclerAdapterHome(List<T> dataSet) {
    ...
    public abstract void updateBadgeCount(String mBadgeCount);
