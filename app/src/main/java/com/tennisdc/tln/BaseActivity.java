...
import com.tennisdc.tln.modules.buy.PaypalSettings;
import com.tennisdc.tln.modules.buy.SignatureVerificationOverrides;
...
//        }
        String env = getResources().getString(R.string.production);
//        String env = getResources().getString(R.string.sandbox);
        if (!PaypalSettings.getEnvironment(this).equals(env)) {
            PaypalSettings.setEnvironment(this, env);
            performReset();
        }
    }
...
//            setupActionBar();
        ...
        SignatureVerificationOverrides.disableAppSwitchSignatureVerification(
                PaypalSettings.isPayPalSignatureVerificationDisabled(this));
//        PayPalOneTouchCore.useHardcodedConfig(this, PaypalSettings.useHardcodedPayPalConfiguration(this));
...
//                (PaypalSettings.useTokenizationKey(this) && !mAuthorization.equals(PaypalSettings.getTokenizationKey(this))) ||
//                !TextUtils.equals(mCustomerId, PaypalSettings.getCustomerId(this))) {
//            performReset();
//        } else {
...
//        mAuthorization = null;
//        mCustomerId = PaypalSettings.getCustomerId(this);
...
//        }
        ...
        String authType = PaypalSettings.getAuthorizationType(this);
        /*if (authType.equals(getString(R.string.tokenization_key))) {
            mAuthorization = PaypalSettings.getTokenizationKey(this);
            setProgressBarIndeterminateVisibility(false);
            onAuthorizationFetched();
            ...
            DemoApplication.getApiClient(this).getClientToken(PaypalSettings.getCustomerId(this),
                    PaypalSettings.getMerchantAccountId(this), new Callback<ClientToken>() {
                        @Override
    ...
    private void setupActionBar() {
        ...
        actionBar.setSelectedNavigationItem(envs.indexOf(PaypalSettings.getEnvironment(this)));
    }
