...
public class PlayerDetail {
    ...
    public boolean CanPushNotification;//: true
    ...
    @SerializedName("playoff_qualified")
    public boolean IsPlayoffQualified;

    @SerializedName("win_loss_diff")
    public String win_loss_diff;

    @SerializedName("profile_active")
    public boolean profile_active;
